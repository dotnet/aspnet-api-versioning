namespace Microsoft.Web.Http.Versioning.Conventions
{
    ...
    public class ControllerApiVersionConventionBuilderExtensionsTTest
    {
        ...
        public void has_api_version_should_add_group_version_parts()
        {
            ...
            // assert
            controllerBuilder.ProtectedSupportedVersions.Single().Should().Be( new ApiVersion( new DateTime( 2016, 9, 10 ) ) );
        }
        ...
        public void has_deprecated_api_version_should_add_group_version_parts()
        {
            ...
            // assert
            controllerBuilder.ProtectedDeprecatedVersions.Single().Should().Be( new ApiVersion( new DateTime( 2016, 9, 10 ) ) );
        }
        ...
        public void advertises_api_version_should_add_group_version_parts()
        {
            ...
            // assert
            controllerBuilder.ProtectedAdvertisedVersions.Single().Should().Be( new ApiVersion( new DateTime( 2016, 9, 10 ) ) );
        }
        ...
        public void advertises_api_version_should_add_group_version_parts_with_status()
        {
            ...
            // assert
            controllerBuilder.ProtectedAdvertisedVersions.Single().Should().Be( new ApiVersion( new DateTime( 2016, 9, 10 ), "alpha" ) );
        }

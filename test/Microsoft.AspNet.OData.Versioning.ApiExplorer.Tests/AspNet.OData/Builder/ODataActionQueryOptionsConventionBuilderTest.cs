namespace Microsoft.AspNet.OData.Builder
{
    ...
    public class ODataActionQueryOptionsConventionBuilderTest
    {
        [Fact]
        ...
        {
            // arrange
            var controllerBuilder = new Mock<ODataControllerQueryOptionsConventionBuilder>( typeof( TestController ) );
            var actionBuilder = new ODataActionQueryOptionsConventionBuilder( controllerBuilder.Object );

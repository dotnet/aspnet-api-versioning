namespace Microsoft.Web.Http.Routing
{
    ...
    {
        static readonly Lazy<Func<IParsedRoute>> createNewFunc = new Lazy<Func<IParsedRoute>>( CreateNewFunc );
        static readonly Lazy<Func<string, object>> parseFunc = new Lazy<Func<string, object>>( NewParseFunc );
        ...
        static Func<IParsedRoute> CreateNewFunc()
        {
        ...
        static Func<string, object> NewParseFunc()
        {

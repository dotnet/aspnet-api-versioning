...
public class when_using_a_url_segment_and_split_into_two_types : BasicAcceptanceTest
{
    [Theory]
    ...
    public when_using_a_url_segment_and_split_into_two_types( BasicFixture fixture, ITestOutputHelper console )

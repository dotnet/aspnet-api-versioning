...
public static class ISunsetPolicyManagerExtensions
{
    ...
    extension( ISunsetPolicyManager policyManager )
    {
        /// <summary>
        ...
        public bool TryGetPolicy( ApiVersion apiVersion, [MaybeNullWhen( false )] out SunsetPolicy sunsetPolicy )
        {
        ...
        /// <param name="sunsetPolicy">The applicable <see cref="SunsetPolicy">sunset policy</see>, if any.</param>
        /// <returns>True if the <paramref name="sunsetPolicy">sunset policy</paramref> was retrieved; otherwise, false.</returns>
        public bool TryGetPolicy( string name, [MaybeNullWhen( false )] out SunsetPolicy sunsetPolicy )
        {
            ArgumentNullException.ThrowIfNull( policyManager );
        ...
        /// </list>
        /// </remarks>
        public SunsetPolicy? ResolvePolicyOrDefault( string? name, ApiVersion? apiVersion )
        {
            ArgumentNullException.ThrowIfNull( policyManager );
        ...
        /// </list>
        /// </remarks>
        public bool TryResolvePolicy( string? name, ApiVersion? apiVersion, [MaybeNullWhen( false )] out SunsetPolicy sunsetPolicy )
        {
            ArgumentNullException.ThrowIfNull( policyManager );

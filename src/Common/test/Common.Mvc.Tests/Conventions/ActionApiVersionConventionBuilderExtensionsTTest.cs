...
public class ActionApiVersionConventionBuilderExtensionsTTest
{
    ...
    private sealed class TestActionApiVersionConventionBuilder : ActionApiVersionConventionBuilder<ControllerBase>
    {
        internal TestActionApiVersionConventionBuilder() : base( new() ) { }

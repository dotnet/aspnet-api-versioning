namespace System.Web.Http
{
    ...
    public static class HttpConfigurationExtensions
    {
        ...
        static void SetResolverSettings( this HttpConfiguration configuration, DefaultODataPathHandler pathHandler )
        {
            ...
            setResolverSettings.Value( pathHandler, configuration.Properties[ResolverSettingsKey] );
        }

        static void SetResolverSettings( this HttpConfiguration configuration, IODataPathHandler pathHandler )
        {
            if ( pathHandler is DefaultODataPathHandler handler )
            {
                configuration.SetResolverSettings( handler );
            }
        }

        internal static void SetResolverSettings( this HttpConfiguration configuration, IODataPathTemplateHandler pathHandler )
        {
            Contract.Requires( configuration != null );

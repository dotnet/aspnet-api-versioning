...
public static class HttpControllerDescriptorExtensions
{
    ...
    extension( HttpControllerDescriptor controllerDescriptor )
    {
        /// <summary>
        /// Gets or sets the API version information associated with a controller.
        /// </summary>
        ...
        /// should use <see cref="HttpActionDescriptorExtensions.get_ApiVersionMetadata(HttpActionDescriptor)"/> instead. Components
        ...
        /// If the controller descriptor is not a composite, it yields itself.</remarks>
        public IEnumerable<HttpControllerDescriptor> AsEnumerable() => controllerDescriptor.AsEnumerable( includeCandidates: false );

        internal IEnumerable<HttpControllerDescriptor> AsEnumerable( bool includeCandidates )
        {
            ArgumentNullException.ThrowIfNull( controllerDescriptor );
        ...
        internal void SetPossibleCandidates( IEnumerable<HttpControllerDescriptor> value ) =>

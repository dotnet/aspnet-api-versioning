...
public static class HttpConfigurationExtensions
{
    ...
    extension( HttpConfiguration configuration )
    {
        ...
        public ODataApiExplorer AddODataApiExplorer()
        {
        ...
        public ODataApiExplorer AddODataApiExplorer( Action<ODataApiExplorerOptions> setupAction )
        {
            if ( configuration == null )
            {
                throw new ArgumentNullException( nameof( configuration ) );
        ...
        private ODataApiExplorer AddODataApiExplorer( ODataApiExplorerOptions options )
        {
        ...
        internal IServiceProvider GetODataRootContainer( IHttpRoute route )
        {

...
public static class HttpConfigurationExtensions
{
    ...
    extension( HttpConfiguration configuration )
    {
        ...
        public ODataRoute MapVersionedODataRoute( string routeName, string routePrefix, VersionedODataModelBuilder modelBuilder )
        {
        ...
        /// <returns>The added <see cref="ODataRoute"/>.</returns>
        public ODataRoute MapVersionedODataRoute(
            string routeName,
            string routePrefix,
        ...
        /// <param name="models">The <see cref="IEnumerable{T}">sequence</see> of <see cref="IEdmModel">EDM models</see> to use for parsing OData paths.</param>
        /// <returns>The added <see cref="ODataRoute"/>.</returns>
        public ODataRoute MapVersionedODataRoute( string routeName, string routePrefix, IEnumerable<IEdmModel> models ) =>
            AddApiVersionConstraintIfNecessary(
                configuration,
        ...
        internal ODataUrlKeyDelimiter? UrlKeyDelimiter
        {
            get
            {
    ...
    private static ODataRoute AddApiVersionConstraintIfNecessary( HttpConfiguration configuration, ODataRoute route )
    {
        ...
        var options = configuration.ApiVersioningOptions;

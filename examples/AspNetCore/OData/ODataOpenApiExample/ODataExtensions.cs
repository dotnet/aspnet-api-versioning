...
internal static class ODataExtensions
{
    ...
    {
        public IReadOnlyDictionary<string, object> GetRelatedKeys( Uri uri )
        {
        ...
        public object GetRelatedKey( Uri uri ) => controller.GetRelatedKeys( uri ).Values.SingleOrDefault();
    }
}
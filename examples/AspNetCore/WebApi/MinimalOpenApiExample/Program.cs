...
// 1.0
var o1 = orders.MapGroup( "/api/orders" )
               .HasDeprecatedApiVersion( 0.9 )
               .HasApiVersion( 1.0 );

o1.MapGet( "/{id:int}", ( int id ) => new OrderV1() { Id = id, Customer = "John Doe" } )
  .Produces<OrderV1>()
  .Produces( 404 );

o1.MapPost( "/", ( HttpRequest request, OrderV1 order ) =>
   {
       order.Id = 42;
...
o1.MapMethods( "/{id:int}", new[] { HttpMethod.Patch.Method }, ( int id, OrderV1 order ) => Results.NoContent() )
  .Accepts<OrderV1>( "application/json" )
  .Produces( 204 )
  .Produces( 400 )
  .Produces( 404 )
...
// 2.0
var o2 = orders.MapGroup( "/api/orders" )
               .HasApiVersion( 2.0 );
...
o2.MapGet( "/{id:int}", ( int id ) => new OrderV2() { Id = id, Customer = "John Doe" } )
  .Produces<OrderV2>()
  .Produces( 404 );

o2.MapPost( "/", ( HttpRequest request, OrderV2 order ) =>
   {
       order.Id = 42;
       var scheme = request.Scheme;
       var host = request.Host;
...
o2.MapMethods( "/{id:int}", new[] { HttpMethod.Patch.Method }, ( int id, OrderV2 order ) => Results.NoContent() )
  .Accepts<OrderV2>( "application/json" )
  .Produces( 204 )
  .Produces( 400 )
  .Produces( 404 );
...
// 3.0
var o3 = orders.MapGroup( "/api/orders" )
               .HasApiVersion( 3.0 );
...
o3.MapGet( "/{id:int}", ( int id ) => new OrderV3() { Id = id, Customer = "John Doe" } )
  .Produces<OrderV3>()
  .Produces( 404 );

o3.MapPost( "/", ( HttpRequest request, OrderV3 order ) =>
   {
       order.Id = 42;
       var scheme = request.Scheme;
       var host = request.Host;
...
o3.MapDelete( "/{id:int}", ( int id ) => Results.NoContent() )
  .Produces( 204 );

// 1.0
var p1 = people.MapGroup( "/api/v{version:apiVersion}/people" )
               .HasDeprecatedApiVersion( 0.9 )
               .HasApiVersion( 1.0 );

p1.MapGet( "/{id:int}", ( int id ) =>
   new PersonV1()
   {
       Id = id,
       FirstName = "John",
...
// 2.0
var p2 = people.MapGroup( "/api/v{version:apiVersion}/people" )
               .HasApiVersion( 2.0 );
...
// 3.0
var p3 = people.MapGroup( "/api/v{version:apiVersion}/people" )
               .HasApiVersion( 3.0 );
...
p3.MapPost( "/", ( HttpRequest request, ApiVersion version, PersonV3 person ) =>
   {
       person.Id = 42;
       var scheme = request.Scheme;
       var host = request.Host;
